...
data class Attribution(
    ...
    @Parsed(field = ["is_producer"], applyDefaultConversion = false) @Convert(conversionClass = NullableBooleanConversion::class) val isProducer: Boolean?,
    @Parsed(field = ["is_operator"], applyDefaultConversion = false) @Convert(conversionClass = NullableBooleanConversion::class) val isOperator: Boolean?,
    @Parsed(field = ["is_authority"], applyDefaultConversion = false) @Convert(conversionClass = NullableBooleanConversion::class) val isAuthority: Boolean?,
